...
<head>
    <meta charset="UTF-8">
    <title>Student Management - Insert Data</title>
...
//===============image validation===============               
        ...
        ?>
                    ...
                    <div class="form-row">
                        <div class="row my-3">
                            <select id="city" class="city" name="city">
                                ...
                                <option value="Ajmer">Raigarh</option>
                                <option value="Kota">sariya</option>
                                <option value="Jaipur">Pussore</option>
                                <option value="Udaipur">Baramkela</option>
                                <option value="Bikaner">raipur</option>
                            </select>
                        </div>
                        <div class="row">
                ...
                <p class="footer text-center pt-4 mt-5">Made by Hitesh </p>
            </div>
        </div>
